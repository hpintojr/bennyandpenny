...
import { AccessibilityPreferencesProvider, AccessibilityPreferencesTrigger } from "@/components/AccessibilityPreferences";
      ...
      <>
        <style>{`
          ...
          @media (max-width: 520px) {
            .footerBrandLockup { gap: .7rem; }
            .footerBrandLockup .footerMark { width: 58px; height: 58px; }
          }
        `}</style>
